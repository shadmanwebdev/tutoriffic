...
?>
    ...
    <div class='bg-silver-300'>
        ...
        <div class="content login-content">
            <form id="login-form" class="login-form" onsubmit='return support_signup(event)' method='POST'>
                <input type="hidden" id="create_support_account" name="create_support_account" value="true">

    ...
    if(
        ...
        .then(response => { 
            if(response == 'message limit exceeded') {
                var message_response = "You have reached the limit of 10 unique students you can message in the last 30 days.";
                $('#contentError').html("<span class='error'>" + message_response + "</span>");
            } else {

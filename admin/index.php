...
<script defer>
    function get_popup_content_2(id) {
        console.log(id);

        fetch('./confirm-delete-popup-2.php?type=booking&id='+id)
        .then(response => response.text())
        .then(response => {
            console.log(response);
            // setTimeout(function() {

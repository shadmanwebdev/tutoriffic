...
<nav id="sidebar" class="sidebar">
    <div class="sidebar-content js-simplebar" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
        ...
        <ul class="sidebar-nav">
            ...
            <!-- <li class="sidebar-item">
                <a data-target="#ui3" data-toggle="collapse" onclick="toggleDropdown('ui3')" class="sidebar-link collapsed">
                    <span class="align-middle">Services & Add Ons</span>
                </a>
                <ul id="ui3" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item"><a style='display: flex; flex-flow: row nowrap; align-items: center; color: #fff;' class="sidebar-link" href="services"><i class='ion-ios-arrow-thin-right'></i>Services</a></li>
                    <li class="sidebar-item"><a style='display: flex; flex-flow: row nowrap; align-items: center; color: #fff;' class="sidebar-link" href="create-service"><i class='ion-ios-arrow-thin-right'></i>New Service</a></li>
                    <li class="sidebar-item"><a style='display: flex; flex-flow: row nowrap; align-items: center; color: #fff;' class="sidebar-link" href="edit-service?id=39"><i class='ion-ios-arrow-thin-right'></i>Edit Service</a></li>
                </ul>
            </li>
            <li class="sidebar-item">

...
<div class='container confirmation-container'>
    ...
    <h4>Congratulations, your ad is online!</h4>
    <div data-v-22de3638="" class="card-infos-container">
        ...
        <div data-v-22de3638="" class="card">
            ...
            <div data-v-22de3638="" class="infos">
                <h5 data-v-22de3638="">Shadman</h5>
                <p data-v-22de3638="">Maths</p>
            </div>
    ...
    <p data-v-22de3638="" class="text" data-label="ad_c_step_10_demand_reco">
        Ask for <b>recommendations</b> from your friends to add value to your profile and to make sure your ad is <b>better positioned</b> in student search results!
    </p>

    <input style='margin-top: 50px;' type="submit" class="form-btn btn btn-validate" value="Validate ad">
</div>

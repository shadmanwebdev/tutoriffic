<?php
    ...
    if(isset($_GET['ad_id'])) {
        ...
        // When redirected from tutor profile
...
<script src="js/schedule.js?v=10" defer></script>
...
<div class='container page-wrapper schedule'>
    <div class='row tab tab-1 active-tab'>
        ...
        <div class='col-lg-4 col-md-12'>
            <?php
                $ad = new Ad();
                $tutor_id = $ad->get_single_ad($ad_id)['tutor_uid'];
...
<?php
        ...
        if (
            $lastVisitedPage != 'tutor-profile' && 
            $lastVisitedPage != 'tutor-profile.php'
        ) {
?>
    <script defer>
        popup('month-outer-wrapper');
